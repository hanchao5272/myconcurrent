...
/**
 * <p>并发 线程安全实例</p>
 * @author hanchao 2018/3/11 12:05
 **/
public class ConcurrentAOVDemo {
    private static final Logger LOGGER = Logger.getLogger(ConcurrentAOVDemo.class);
    ...
    /**
     * <p>线程安全示例：通过synchronized保证代码块的安全示例</p>
    ...
    /**
     * <p>线程安全示例：通过Lock接口保证指定范围捏代码的安全示例</p>
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        LOGGER.info("Java提供的能够保证更大范围操作安全示例的技术有：1.synchronized关键字、2.Lock接口、3.Atomic类型\n");
        //不进行安全示例保护的大范围操作
...
//        LOGGER.info("进过" + num + "次自增，count应该 = " + (begin + num) + ",实际count = " + increment.getCount());
        ...
        //synchronized关键字能够保证安全示例（代码块锁，多线程操作某一对象时，在某个代码块内只能单线程执行）
